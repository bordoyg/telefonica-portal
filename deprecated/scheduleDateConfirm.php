	...
	<div id="cont_agend">
		...
		<div class="container">
			<div class="box_cont_2 col_green box_square">
				...
				<h2 class="text_center">Te confirmamos la cita para atender tu
					orden:</h2>
				<h3 class="text_center">
					...
					echo 'Fecha: ' . $dateStart->format('jS F Y') . '<br>Jornada: ' . $activity->timeSlot . '(' . $dateStart->format('g:i A') . ' - ' . $dateEnd->format('g:i A') . ')';
					?>
				</h3>
				<h4>No olvides:</h4>
